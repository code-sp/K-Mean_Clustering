...
char buff ;  
FILE *fp = fopen("Student List.csv","r") ;
...
for (i=0; i<line-1;i++)
{
	a[i]=abs(dataa[i][5]-mean[0]);
	b[i]=abs(dataa[i][5]-mean[1]);
	c[i]=abs(dataa[i][5]-mean[2]);
